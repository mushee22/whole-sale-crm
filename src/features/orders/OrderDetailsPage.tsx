...
export default function OrderDetailsPage() {
    ...
    return (
        <div className="space-y-6 max-w-7xl mx-auto">
            <PermissionGuard module="orders" action="view_detail" showMessage>
                {/* Header Actions */}
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 pb-6">
                    <div>
                        <h1 className="text-xl md:text-3xl font-bold text-slate-900 tracking-tight flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="text-right">
                            ...
                            <div className="text-lg md:text-2xl font-bold text-slate-900">₹{order.total_amount}</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <Card className="shadow-sm border-gray-100">
                            <CardHeader>
                                <CardTitle className="text-base md:text-lg font-semibold">Order Items</CardTitle>
                            </CardHeader>
                    ...
                    <div className="space-y-6">
                        <Card className="shadow-sm border-gray-100">
                            <CardHeader>
                                <CardTitle className="text-base md:text-lg font-semibold">Customer Details</CardTitle>
                            </CardHeader>
